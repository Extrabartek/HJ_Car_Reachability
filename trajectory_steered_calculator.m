...
brs_folder = fullfile(main_results_folder, 'steered_brs_results_20250415_100717_vx30-30_dvmax20-20');
...
xinit = [deg2rad(-25); deg2rad(-5); deg2rad(0)];
...
max_time = 0.25;           % Maximum trajectory time (seconds)
