function visualize_interactive_safe_set(g, safe_set, brs, frs, velocity, control_limit, control_type)
...
axes(ax_2d);
[h_brs, h_frs, h_safe, h_safe_region] = initialize_2d_slice(current_slice_idx);

% Initialize 3D visualization (right panel)
axes(ax_3d);
[h_brs_3d, h_frs_3d, h_safe_3d, h_slice_plane] = initialize_3d_view();
...
%% Nested function to initialize 2D slice visualization
    function [h_brs, h_frs, h_safe, h_safe_region] = initialize_2d_slice(slice_idx)
...
%% Nested function to initialize 3D visualization
    function [h_brs_3d, h_frs_3d, h_safe_3d, h_slice_plane] = initialize_3d_view()
