...
gridMin = [deg2rad(-30), deg2rad(-5), deg2rad(-2)];

% Grid maximum values (radians)
gridMax = [deg2rad(30), deg2rad(5), deg2rad(2)];
...
result_folder = strcat(main_results_folder,'steered_brs_results_20250414_154032_vx30-30_dvmax20-20'); 
